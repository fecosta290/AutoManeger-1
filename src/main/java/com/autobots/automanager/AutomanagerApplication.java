...
public class AutomanagerApplication implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    fornecedor.setNomeSocial(
      "Loja do carro, vendas de componentes automotivos"
    );
    ...
    rodaLigaLeve.setDescricao(
      "Roda de liga leve original de fábrica da toyta para modelos do tipo hatch"
    );
